...
var buildMaps = function buildMaps(prefix, actionAndSagaMap, defaultTakeEffect, checkAndWarn, logBuilt) {
    ...
    (0, _keys2.default)(actionAndSagaMap).forEach(function (actionName) {
        ...
        var actionFields = getSagaActionFields(saga, actionType);

        if (checkAndWarn) {
            (0, _check2.default)(saga, actionType, actionFields);
        }
        ...
        if (logBuilt) {
            console.log("Saga actionCreator: " + actionName + "(" + actionFields.join(", ") + ")   " + "--->   type: '" + actionType + "'");
        }
    });
...
var getSagaActionFields = function getSagaActionFields(saga) {
    return saga != null ? (0, _actionFields2.default)(saga) || [] : [];
};
...
var GooseFactory = function () {
    function GooseFactory(actionTypePrefix, actionAndSagaMap) {
        ...
        var _buildMaps = buildMaps(actionTypePrefix, actionAndSagaMap, defaultTakeEffect, checkAndWarn, logBuilt && canLog),
