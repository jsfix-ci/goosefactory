...
var GooseFactory = function () {
    function GooseFactory(actionTypePrefix, actionAndSagaMap) {
        ...
        var _buildMaps = buildMaps(actionTypePrefix, actionAndSagaMap, defaultTakeEffect, checkAndWarn, logBuilt && window.console),
...
GooseFactory.createRootSaga = function (sagaMapArray, mergedTakeEffectMap) {
